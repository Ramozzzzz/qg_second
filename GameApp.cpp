...
bool GameApp::InitEffect()
{
	...
	// 创建顶点着色器
	HR(CreateShaderFromFile(L"HLSL\\Hexagon_VS.cso", L"HLSL\\Hexagon_VS.hlsl", "VS", "vs_5_0", blob.ReleaseAndGetAddressOf()));
	...
	// 创建像素着色器
	HR(CreateShaderFromFile(L"HLSL\\Hexagon_PS.cso", L"HLSL\\Hexagon_PS.hlsl", "PS", "ps_5_0", blob.ReleaseAndGetAddressOf()));
