...
bool GameApp::InitEffect()
{
	...
	// 创建顶点着色器
	HR(CreateShaderFromFile(L"HLSL\\Ladder_platform_VS.cso", L"HLSL\\Ladder_platform_VS.hlsl", "VS", "vs_5_0", blob.ReleaseAndGetAddressOf()));
	...
	// 创建像素着色器
	HR(CreateShaderFromFile(L"HLSL\\Ladder_platform_PS.cso", L"HLSL\\Ladder_platform_PS.hlsl", "PS", "ps_5_0", blob.ReleaseAndGetAddressOf()));
