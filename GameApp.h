...
public:
	...
	enum class ShowMode { WoodCrate1, WoodCrate2, FireAnim };
...
private:
	...
	std::vector<ComPtr<ID3D11ShaderResourceView>> m_pWoodCrate;	// 木盒纹理
	ComPtr<ID3D11ShaderResourceView> m_pWoodCrate1;
	ComPtr<ID3D11ShaderResourceView> m_pWoodCrate2;
	ComPtr<ID3D11ShaderResourceView> m_pWoodCrate3;
	ComPtr<ID3D11ShaderResourceView> m_pWoodCrate4;
	ComPtr<ID3D11ShaderResourceView> m_pWoodCrate5;
	ComPtr<ID3D11ShaderResourceView> m_pWoodCrate6;
